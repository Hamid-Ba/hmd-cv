...
const Post = () => {
    ...
    return (
        <div className="rtl max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 relative">
          <div className="mb-5 max-w-2xl mx-auto">
            <img
              src={`/images/${post.image}`}
              className="bg-cover text-center overflow-hidden"
            />
            <h1 href="#" className="text-gray-900 font-bold text-3xl mt-5 mb-5">
              {post.title}
            </h1>
            <div className="text-gray-700 text-xs flex my-6 flex justify-between">
              <div className="flex items-center">
                ...
                <div className="text-sm mr-2">
                  ...
                  <p className="text-gray-600 text-xs">{post.insertedAt}</p>
                </div>
              </div>
