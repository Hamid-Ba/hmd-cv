        ...
        <div className="contacts--container">
          ...
          <div className="contacts-body">
                  ...
                  <button type="submit" className="bg-primary">
                    ...
                    <div className="submit-icon">
                      <svg
                        ...
                        style={{animation : "initial" , position : "initial"}}
                      >
                        <defs></defs>
            ...
            <div className="contacts-details">
              <a href={"mailto:" + contact.email} className="personal-details">
                ...
                <p style={{fontFamily : "sans-serif"}}>{contact.email}</p>
              </a>
              <a href={"tell:" + contact.phone} className="personal-details">
                <div className="bg-primary">
                  <svg
                    stroke="currentColor"
                    fill="none"
                ...
                <p style={{fontFamily : "sans-serif"}}>{contact.phone}</p>
              </a>
